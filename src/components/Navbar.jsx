...
function Navbar() {
  ...
  return (
    <nav className="nav flex justify-between items-center px-32 py-5 text-white">
      <div className="flex items-center space-x-5 cursor-pointer">
        <BsFillBadge8KFill className="text-5xl" />
        <h1 className="font-bold text-2xl">Choi</h1>
      </div>
      <div className="">
        <section
          className={
            list
              ? "flex items-center space-x-5 cursor-pointer ease-in-out duration-1000"
              : "hidden"
          }
          onClick={handleClick}
        >
        ...
        >
          ...
          <ul className="">
            <li className="py-2 pr-32 border-b border-gray-600">
              <a href="#">
                <span>01. </span>Home
              </a>
            </li>
